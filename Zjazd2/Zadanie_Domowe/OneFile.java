...
public class DataConfiguration {
        ...
        //Bean będzie tworzony tylko kiedy dane application.properties ma wartość true/false w custom.flag
        @Bean
...
my.custom.property=Hello from application properties  //Jeśli to będzie puste to wartość będzie wyświetlana jako Default Value
