...
public class CurrencyService {
    ...
    public double calculateAverageExchangeRate(CurrencyType currency, LocalDate queryDate) {
        // Pobierz dane z API NBP dla danej waluty i liczby dni
        String apiUrl = "http://api.nbp.pl/api/exchangerates/rates/A/{currency}/{date}";
        String url = apiUrl.replace("{currency}", currency.name())
                .replace("{date}", queryDate.toString());
        ...
        currencyQuery.setQueryDate(queryDate);
